<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Towar_form.aspx.cs" Inherits="WebApplication1.Towar_form" %>
...
<body bgcolor="#995e34">
    ...
    <form id="form3" runat="server">
        ...
        <br /><br />
        <asp:Button ID="Button3" runat="server" Text="Dodaj Towar" OnClick="Button3_Click" />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Usun Towar" />
    </form>
    </center>
    </body>
</html>
